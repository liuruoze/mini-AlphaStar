...
" Borrowed from DI-Star for efficient use. Has modified." 
...
def get_available_actions_raw_data(obs):
    ...
    for function in FUNCTION_LIST:
        if function.func_id in range(37, 49):  # protoss buildings actions exclue Nexus, Pylon, and Assimilator
            if (60 in units_set):  # all protoss buildings need Pylon
    ...
    ava_action = np.zeros((1, SFS.available_actions))

    for t in vector:
        ava_action[0, t.func_id] = 1
