...
After downloading replays, you should move the replays to "./data/Replays/filtered_replays_1" (the name can be changed if you modify the source code in transform_replay_data.py).
